    ...
    $data_sets['v1'] = array(
        'taxonomies' => array(
            "tax_preset_denominacao" => array(
                ...
                "status" => "publish",
                "allow_insert" => "yes",
                "file" => "v1/files/tax_preset_denominacao.csv"
            ),
            "tax_preset_autor" => array(
                ...
                "status" => "publish",
                "allow_insert" => "yes",
                "file" => "v1/files/tax_preset_autor.csv"
            ),
            "tax_preset_classificacao" => array(
                ...
                "status" => "publish",
                "allow_insert" => "yes",
                "file" => "v1/files/tax_preset_classificacao.csv"
            ),
            "tax_preset_material_tecnica" => array(
                ...
                "status" => "publish",
                "allow_insert" => "yes",
                "file" => "v1/files/tax_preset_material_tecnica.csv"
            )
        ),
        'collection' => array(
            'name' => 'INBCM',
